...
import { Camera, RotateCcw, Download, Share2, Sparkles, Sun, Contrast, Droplets } from 'lucide-react';
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, marginLeft: 'var(--sidebar-width)', padding: '24px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ maxWidth: 480, width: '100%' }}>
          ...
          {/* Preview */}
          <div style={{ width: '100%', aspectRatio: '3/4', borderRadius: 24, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', position: 'relative', overflow: 'hidden', marginBottom: 16, border: '1px solid var(--border-default)', filter: combinedFilter, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center' }}>
              <div className="avatar-placeholder" style={{ width: 120, height: 120, fontSize: 42, margin: '0 auto 16px' }}>📸</div>
            ...
            <div style={{ position: 'absolute', inset: 0, backgroundImage: 'linear-gradient(rgba(255,255,255,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.05) 1px, transparent 1px)', backgroundSize: '33.33% 33.33%', pointerEvents: 'none' }} />
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
            <button
              style={{ width: 70, height: 70, borderRadius: '50%', background: 'white', border: '4px solid var(--border-strong)', cursor: 'pointer', boxShadow: '0 4px 20px rgba(0,0,0,0.4)' }}
